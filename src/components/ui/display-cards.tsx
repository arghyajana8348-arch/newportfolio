...
function DisplayCardMobile({
  ...
  return (
    <div
      className="flex w-full max-w-[22rem] flex-col justify-between rounded-xl border border-border bg-surface-elevated/45 backdrop-blur-sm p-4 gap-3 transition-all duration-300 hover:border-primary/30"
    >
